...
export default function Chart2({
  ...
  const additionalPrice = (priceGivenOnSlider - carbonPriceToday) / countOfYears;
  ...
  const diffOfMonthByYear = range(1, countOfYears).map(i => pricesByYear[i] * avgByYear[i] * rate);
